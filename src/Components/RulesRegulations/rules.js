  ...
  dance: [
    {
      ...
      rules: [
        ...
        "Three copies, containing a brief description of the performance is to be submitted in a typed format along with the entry form at the reporting time to the event incharge.",
    ...
    },
    {
      ...
      rules: [
        ...
        "Three copies, containing a brief explanation of the theme is to be submitted in a typed format along with the entry form at the reporting time to the event incharge.",
        "Pre-recorded music in MP3 format is to be submitted in a pendrive at the reporting time to the event incharge.",
        "Reporting time will be provided along with the schedule of the event.",
        "Decision of the organizers and the panel of judge(s) will be final and binding.",
      ],
  ...
  "fine-arts": [
    {
      ...
      rules: [
        ...
        "A3 size paper of dimensions 297 mm x 420 mm will be provided by the host institute.",
    ...
    },
    {
      ...
      rules: [
        ...
        "Materials or products required for the competition shall be brought by the participant.",
        "The space for the installation shall be provided by the host institute.",
        "The participant shall create and install an artwork related to the topic of the installation in the assigned area. The maximum size of the installation shall be 5'x5'x5'.",
