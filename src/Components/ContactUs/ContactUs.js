    ...
    <>
      ...
      <div className="container ">
        ...
        <div className="row gx-5 d-flex justify-content-around .flex-column">
          <div
            className="col-lg-5 col-md-6 shadow p-5 rounded"
            style={{
              backgroundColor: "#b8ecff",
              backgroundImage:
                "linear-gradient(315deg, rgba(255,255,255,1) 0%, rgba(112,230,254,1) 100%)",
            }}
          >
            <form
            ...
            >
              <div className="w-100 d-flex justify-content-center align-items-center">
                <h3 className="fw-bold">Feel free to reach to us!</h3>
                {/* <img src={messageIcon} width="30rem" style={{ margin: "10px" }}></img> */}
              </div>
              <label htmlFor="contact-us-name" className="form-label fs-5">
                Full Name
              </label>
              <input
                type="text"
